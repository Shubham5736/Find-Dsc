...
# for i in range(len(xvals_1)-1):
#     plot.add_layout(Arrow(end=NormalHead(size=5),x_start=xvals_1[i],y_start=yvals_1[i],x_end=xvals_1[i+1],y_end=yvals_1[i+1],line_width=0))

#Global node size and default color
graph.node_renderer.glyph = Circle(size=20, fill_color='skyblue')
plot.renderers.append(graph)

#coloring the edges for shortest paths
path1_color, path2_color, path3_color ,normal_color ='red', 'green', 'yellow', 'black'
...
graph_renderer.node_renderer.glyph = Circle(size=20, fill_color='skyblue')
...
print("<div id='pathstr'> \n<b>Code - Path from",source,"to",destination,":</b><br>")
print(pathstr,"<br>")
#cost
...
#print("Time taken to find and plot graph:", end-start)
